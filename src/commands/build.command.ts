...
async function buildAssetsFolder(): Promise<void> {
  const start = new Date().getTime();
...
async function buildI18NFolder(): Promise<void> {
  const start = new Date().getTime();
...
async function buildLayoutsFolder(): Promise<void> {
  const start = new Date().getTime();
...
async function buildViewsFolder(): Promise<void> {
  const start = new Date().getTime();
...
async function buildHtAccess(): Promise<void> {
  const start = new Date().getTime();
...
async function buildIndexPhp(): Promise<void> {
  const start = new Date().getTime();
...
async function postProcessDir(dir: string): Promise<void> {
...
async function createRuntimePhp(): Promise<void> {
  const start = new Date().getTime();
