...
import { I18N_TAG, LANG_TAG, URL_PAGE_TAG, URL_LANG_TAG, URL_ASSET_TAG, Config } from './models/config.mjs';
...
export async function replaceAssetUrlForStyle(config: Config, pageOutputDir: string, input: string): Promise<string> {
