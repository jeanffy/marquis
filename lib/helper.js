...
exports.fileAppend = exports.getFolderItems = exports.exportTemplate = exports.callTwig = exports.fileExists = exports.promiseSpawn = exports.twigRenderFilePromise = exports.logActionProgress = exports.logAction = void 0;
...
function logActionProgress(message) {
    console.log(`     ${message}`);
}
