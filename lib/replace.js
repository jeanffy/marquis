...
import { I18N_TAG, LANG_TAG, URL_PAGE_TAG, URL_LANG_TAG, URL_ASSET_TAG } from './models/config.js';
...
export async function replaceAssetUrlForStyle(config, page, input) {
...
export async function replaceAssetUrlForStyleNew(config, pageOutputDir, input) {
    return replaceTag(input, URL_ASSET_TAG, (p) => {
