...
(function (ConsoleColors) {
    ...
    function notice(message) {
        return `${ConsoleColors.dim}${message}${ConsoleColors.reset}`;
    }
    ConsoleColors.notice = notice;
    function info(message) {
        return `${ConsoleColors.bright}${message}${ConsoleColors.reset}`;
    }
    ConsoleColors.info = info;
    function success(message) {
        return `${ConsoleColors.fgGreen}${message}${ConsoleColors.reset}`;
    }
    ConsoleColors.success = success;
    function warning(message) {
        return `${ConsoleColors.fgYellow}${message}${ConsoleColors.reset}`;
    }
    ConsoleColors.warning = warning;
    function error(message) {
        return `${ConsoleColors.fgRed}${message}${ConsoleColors.reset}`;
    }
